...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7836070263:AAGiLmHBDFZ98P-hpvk6LoaBXhFqbR0kAPY")
...
DB_NAME = os.environ.get("DB_NAME", "Pream")


CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002199934355"))
FORCE_SUB_CHANNEL_1 = int(os.environ.get("FORCE_SUB_CHANNEL_1", "-1002459100850"))

FORCE_SUB_CHANNEL_2 = int(os.environ.get("FORCE_SUB_CHANNEL_2", "-1002448901304"))
