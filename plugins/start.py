...
async def start_command(client: Client, message: Message):
    ...
    [
        [
            InlineKeyboardButton('⚡ 𝙹𝚘𝚒𝚗 𝙲𝚑𝚊𝚗𝚗𝚎𝚕 ⚡', url=f'https://t.me/In_Tamil_Anime')
        ],
        [
...
async def not_joined(client: Client, message: Message):
    buttons = [
        [
            InlineKeyboardButton(text="⚡️ Join Channel 1 ⚡️", url=client.invitelink),
            InlineKeyboardButton(text="⚡️ Join Channel 2 ⚡️", url=client.invitelink2),
        ]
    ]
    try:
        buttons.append(
